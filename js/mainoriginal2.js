  ...
  "features": [
   {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Мультимодальный контейнерный сервис","Москва, 4-ый Добрынинский пер., вл.8, офис 201<br>+7(495) 981-98-93<br>info@mcs.su"),
  ...
  /*
    {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Дивизион \"Автоколонна\" ООО \"МКС\" ","Адрес: 115516, Москва, Тарный проезд д11. Офис 315.<br> : +7(495)926-79-66<br>  avtomcs@mcs.su"),
   ...
   // ,

     {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Филиал г.Новороссийск  ","+7(918)499-17-77<br>+7(988)321-47-47<br>lyashik@mcs.su"),
...

     {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Филиал г.Санкт-Петербург "," +7 (911)279-41-04<br>Yasev@mcs.su"),
...

    {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Филиал г.Новосибирск ","г.Новосибирск, ул.Маневровая, дом 9, офис 302.<br>  +7 (343)287-48-24<br>ubakaeva@mcs.su<br> "),
                "clusterCaption": "Филиал г.Новосибирск  ",
    ...
    },
    {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Филиал г.Екатеринбург ","г.Екатеринбург, ул.Маневровая, дом 9, офис 302.<br>  +7 (343)287-48-24<br>ubakaeva@mcs.su<br>  "),
...

    {
      ...
      "properties": {
                "balloonContent": fillTable(logo,
                  " Honrus Shipping (China) Co., Ltd."," Unit L, 17/Fl., International Shipping & Finance Building,<br> 720 Pudong Ave., Shanghai, 200120, P.R.China<br> Fax: 86 21 5186-2626<br> E-mail: marketing@honrus.com<br> <h2>Trans Shine Int'l Forwarding Co.,LTD.</h2> 3103 Rm, CBD Living and Scene, Building 4 Unit 2, No. 109<br> Shandong RD, Qingdao, China 266001<br> TEL : 0086-532-5567 1961/2/3/4/5<br> FAX : 0086-532-5567 1969<br> PIC - Mr. Alan Jiang<br> E-mail: alanjiang@transshine.com"),

                "clusterCaption": "Представиьство г.Шанхай (КНР) ",
...

    {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Филиал г.Хабаровск ","г. Хабаровск, ул Комсомольская, дом 79, лит А, офис 305(здание гостиницы \"Саппоро\")<br>  +7(4212)30-40-62<br>Chernysheva@mcs.su"),
    ...
    ,
     ...
     /*{
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Представиьство Китай ","Honrus Shipping (China) Co., Ltd.<br> Unit L, 17/Fl., International Shipping & Finance Building,<br> 720 Pudong Ave., Shanghai, 200120, P.R.China<br> Tel: 86 21 5036-7917<br> Fax: 86 21 5186-2626<br> E-mail: marketing@honrus.com"),
                "clusterCaption": "Представиьство Китай ",
        "hintContent": "Китай  "
      }
    },
       {
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Представиьство Китай ","Trans Shine Int\"l Forwarding Co.,LTD<br> 3103 Rm, CBD Living and Scene, Building 4 Unit 2, No. 109<br> Shandong RD, Qingdao, China 266001<br> TEL : 0086-532-5567 1961/2/3/4/5<br> FAX : 0086-532-5567 1969<br> PIC - Mr. Alan Jiang<br> E-mail: alanjiang@transshine.com"),
                "clusterCaption": "Представиьство Китай ",
        "hintContent": "Китай  "
      }
    }*/
   // ,
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Представиьство Корея <br>г.Пусан","CIS Logistics Co.,Ltd.<br> Tel: 82-2-725-1773~4; Fax: 82-2-725-1779, 1780<br> PIC: Mr.Eom<br> Tel: 82-2-3276-2004/5; Fax: 82-2-3276-2006<br> Mobile: 82-10-4541-0965<br>dseom@cislogis.com"),
                "clusterCaption": "Представиьство г.Пусан ",
        "hintContent": "Корея   "
      }
    },
      /*{
      ...
      "properties": {
                "balloonContent": fillTable(logo,"Представиьство Тайвань  ","MAYTRANS INTERNATIONAL CORP.<br> 26-6 NO. 31 HAI-PIEN ROAD KAOHSIUNG, TAIWAN R.O.C.<br> Tel.: 886-7 336 2189<br> PIC: Mr. FORD KOU<br>fordk@maytrans.com.tw"),
                "clusterCaption": "Представиьство Тайвань ",
        "hintContent": "Тайвань "
      }
    },*/
...
var yourval = jQuery.parseJSON(JSON.stringify(jsn));
 ...
 /*   moscowPlacemark = new ymaps.Placemark([55.76, 37.64], {
                     "balloonContent": fillTable(logo,"Мультимодальный контейнерный сервис","119049, Москва, 4-ый Добрынинский пер., вл.8, офис 201<br>+7(495) 981-98-93<br>  info@mcs.su"),
                "clusterCaption": "Мультимодальный Контейнерный Сервис»",
        "hintContent": "Москва"
            });
